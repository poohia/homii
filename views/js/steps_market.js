...
$(window).load(function() {
  equalheight('#concept .kit h3');
  equalheight('#concept .kit p');

  equalheight('#description .kit h3');
  equalheight('#description .kit p');

  equalheight('footer .block');

  equalheight('#blog .row-slide');
});
...
/* Change blocks height -> equal heights inline-blocks  */    
...
// Add , Dlelete row dynamically
     ...
     $(document).ready(function(){
      ...
      if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
        $(".banner-mid-mobile").show();
        $(".banner-mid").hide();
        $(".banner-design-mobile").show();
        $(".banner-design").hide();

    }else{
        $(".banner-mid-mobile").hide();
        $(".banner-mid").show();
        $(".banner-design-mobile").hide();
        $(".banner-design").show();
    }
